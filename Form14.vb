...
Public Class Form14
    ...
    Public Sub datagridinput()
        If supid <> "" Then
            ...
            con.Open()
            Dim quer As String = "select supplier_pur.sup_id, company, supplier_pur.med_id, medicine.med_name, cost_of_purchase from supplier_details,supplier_pur,medicine where supplier_details.sup_id=supplier_pur.sup_id and supplier_pur.med_id=medicine.med_id and supplier_pur.sup_id=" + supid
    ...
    Public Sub callfunc()
        readvars()
        datagridinput()
        Label6.Text = Form12.Label6.Text
        setreportid()
    End Sub
